...
FUTURE_LIST_DATA = 'future_code_data'
FUTURE_BASE_LIST_DATA = 'future_base_data'
FUTURE_LIST_BY_BASE_DATA = 'future_list_by_base_data'
FUTURE_BASE_BY_CODE_DATA = 'future_base_by_code_data'
...
STOP_FUTURE_DATA = 'future_stop_realtime'
